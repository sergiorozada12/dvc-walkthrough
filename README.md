...
dvc run --force 
    -n train 
    -p train.seed,train.max_iter 
    -d src/pipeline/train.py 
    -d data/prepared/wine_train.csv 
    -d data/prepared/wine_test.csv 
    -o metrics/train 
    -o models/trained 
...
dvc run --force 
    -n evaluate 
    -d src/pipeline/evaluate.py 
    -d models/trained/model.joblib 
    -d data/prepared/wine_test.csv 
    -M metrics/test/scores.json 
    --plots-no-cache metrics/test/metrics.json 
